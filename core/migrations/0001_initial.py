    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trader_type', models.CharField(blank=True, choices=[('crypto', 'Crypto'), ('forex', 'Forex'), ('other', 'Other')], max_length=20, null=True)),
                ('crypto_coins', models.CharField(blank=True, max_length=255, null=True)),
                ('forex_account_type', models.CharField(blank=True, max_length=50, null=True)),
